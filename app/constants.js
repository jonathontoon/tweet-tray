export const XTRA_LARGE_FONT_SIZE = 22;
...
export const BORDER_GREY = '#E6ECF0';
export const GREY = '#657786';
export const MID_GREY = '#B2BBC3';

export const YELLOW = '#ffad1f';
export const RED = '#e02a62';
